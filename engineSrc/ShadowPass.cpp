...
void ShadowPass::createShadowMap()
{
    ...
    _device->transitionImageLayout(_shadowMap.get()->textureImage, _shadowMap.get()->mFormat, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL, 1);
